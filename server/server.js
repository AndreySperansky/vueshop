...
// server.js - это роутер - этой файл, который обрабатывает все запросы
// 4 основных запроса:
...
/* Ключевые файлы: server.js  и  cartRouter.js
server.js - по умолчанию возвращает data - наши товары, остальные действия происходят в cartRouter.js
cartRouter.js - это обработчик все запросов, перенаправляет по url пользователя на какой-то метод
cartRouter.js вызывает модуль (функцию) Handler.js, в котором есть объект actions (с методами: добавление, изменение)
Эти методы (добавление/изменение) содержатся в модуле Cart.js
Наш user работает через url с файлами server.js  и  cartRouter.js   */